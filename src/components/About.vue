		...
		.about-inner(:class="{loaded: loaded}")
			.about-content
				.about-content-scroller
					...
					p One of my favorite things about development is the massive toolbox of languages, libraries, and methodologies that you can pull from. I am #[em not] one of those people who things if you want to be good at design, you have to be bad at logic, or vise-versa. I like to pride myself on being excellent at all aspects of web development. 
